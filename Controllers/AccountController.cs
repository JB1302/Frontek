    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // Para obtener más información sobre cómo habilitar la confirmación de cuentas y el restablecimiento de contraseña,
                // visite https://go.microsoft.com/fwlink/?LinkID=320771
